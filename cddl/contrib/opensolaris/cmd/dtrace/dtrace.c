...
usage(FILE *fp)
{
	...
	(void) fprintf(fp, "Usage: %s [-32|-64] [-1aACdeFGhHlqSvVwZ] "
	...
	(void) fprintf(fp, "\n"
	    "\t-1  specify benchmark file suffix [default: userspace_e2e.json]\n"
...
listen_dtraced(void *arg)
{
	...
	int fd;
	int err;
	char template[128] = "/tmp/ddtrace-elf.XXXXXXXXXXXX";
	int tmpfd;
